class WhipDancer extends Dancer {
  constructor (top, left, timeBetweenSteps, head = '&#x1f600') {
    ...
    var leftHandPose = `<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="head">${head}</span>&nbsp;&nbsp<br>&nbsp;&nbsp;_/||\\&#x1f44a<br>&nbsp;&nbsp;/&oline;&nbsp;&oline;\\&nbsp;`;
    var rightHandPose = `<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="head">${head}</span>&nbsp;&nbsp<br>&#x1f44a/||\\_<br>&nbsp;&nbsp;&nbsp;/&oline;&nbsp;&oline;\\&nbsp;`;
